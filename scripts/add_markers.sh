...
roslaunch turtlebot_gazebo turtlebot_world.launch world_file:=$(rospack find <RoboND_Home_service_robot>)/map/home_service.world" & 
...
xterm -e "cd $(pwd)/../../..;
source devel/setup.bash;
roslaunch turtlebot_gazebo amcl_demo.launch map_file:=$(rospack find <RoboND_Home_service_robot>)/map/home_service.yaml" &
